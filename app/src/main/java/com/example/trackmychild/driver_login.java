...
public class driver_login extends AppCompatActivity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        login.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                if(TextUtils.isEmpty(phone))
                    phone_edittext.setError("Class No. is Mandatory");
                if(TextUtils.isEmpty(licence_no))
                    licence_no_edittext.setError("Roll No. is Mandatory");
        ...
        toolbar.setTitle("Child Register");
        ...
        getWindow().setStatusBarColor(getResources().getColor(R.color.button2, this.getTheme()));
