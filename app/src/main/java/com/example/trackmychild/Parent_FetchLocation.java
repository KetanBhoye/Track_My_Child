...
public class Parent_FetchLocation extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(Parent_FetchLocation.this, "Could not find an activity to place the call.", Toast.LENGTH_SHORT).show();
                }


               /* if (ActivityCompat.checkSelfPermission(Parent_FetchLocation.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED)
                {
        ...
        toolbar.setTitle("Child's  Location");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        int id = item.getItemId();
         ...
         if (id == R.id.share) {
            ...
            String shareBody = "Here is the share content body" + toString();
            ...
            Intent intent = new Intent(Parent_FetchLocation.this, about.class);
            startActivity(intent);
        }
            ...
            LocationCallback mLocationCallback = new LocationCallback() {
                ...
                public void onLocationResult(LocationResult locationResult) {
                    ...
                    if (locationList.size() > 0) {
                        ...
                        Log.i("Parent_FetchLocation", "Location: " + location.getLatitude() + " " + location.getLongitude());
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(Parent_FetchLocation.this,
   ...
   /* @Override
    public boolean onMarkerClick(Marker marker)
    {
        Routing routing = new Routing.Builder()
                ...
                .withListener(Parent_FetchLocation.this)
                .waypoints(new LatLng(latitude, longitude), marker.getPosition())
                .key("AIzaSyAijV3L2HZxiDr9AyEj0XqQFxgOmlohiXo")
                .build();
        routing.execute();
        return false;
    }*/
